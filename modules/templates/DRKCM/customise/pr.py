...
# -------------------------------------------------------------------------
def customise_default_person_controller(r):
    """ User profile customisations """
...
# -------------------------------------------------------------------------
def customise_dvr_person_controller(r):
    """ Case files/list customisations """
...
def pr_person_controller(**attr):
    ...
    def custom_prep(r):
        ...
        # Module-specific customisations
        if r.controller == "dvr":
            customise_dvr_person_controller(r)

        elif r.controller == "default":
            customise_default_person_controller(r)
    ...
    if controller == "dvr":
        ...
        # Set PDF export parameters for ToDos
        ...
        # Custom rheader
        from ..rheaders import default_rheader
