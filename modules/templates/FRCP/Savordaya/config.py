...
def config(settings):
    ...
    #
    settings.custom.context_org_name = "Savordaya"

    settings.custom.org_menu_logo = ("Savordaya", "img", "logo_small.png")
    settings.custom.homepage_logo = ("Savordaya", "img", "logo_large.png")
