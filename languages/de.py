...
'Concluded Visits': 'Abgeschlossene Besuche',
...
'Invalid Visits': 'Ungültige Besuche',
...
'No Visits currently registered': 'Zurzeit keine Besuche registriert',
...
'There is already an ongoing visit for this patient': 'Zu diesem Patienten gibt es bereits einen laufenden Besuch',
...
'Total Records: %(numrows)s': 'Anzahl Datensätze: %(numrows)s',
...
'Visible?': 'Sichtbar?',
'Visit #': 'Besuch Nr.',
'Visit added': 'Besuch hinzugefügt',
'Visit deleted': 'Besuch gelöscht',
'Visit updated': 'Besuch aktualisiert',
'Visit': 'Besuch',
'Visits': 'Besuche',
