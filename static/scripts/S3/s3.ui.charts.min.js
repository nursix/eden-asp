...
f=d3.format(c.valueFormat);a.yAxis.tickFormat(f);b.data("controls")=="off"&&a.showControls(!1);b.data("legend")=="off"&&a.showLegend(!1);c.colors&&a.color(c.colors);var g=b.data("url"),h=b.data("items"),n=this;nv.addGraph(function(){n._getData(function(e){d.datum(e).call(a);a.update();nv.utils.windowResize(a.update);if(g&&h){var l=b.data("series");a.multibar.dispatch.on("elementClick",function(k){var p={};p[h]=k.data.filterKey;l&&(p[l]=k.element.parentElement.__data__.filterKey);k=n._updateURL(g,
p);window.open(k,"_blank")})}})});return a},_updateURL:function(d,b){var c=document.createElement("a");c.href=d;d=[];for(var a in b)d.push(encodeURIComponent(a)+"="+encodeURIComponent(b[a]));d.length&&(c.search=c.search?c.search+d.join("&"):"?"+d.join("&"));return c.href},_pieChart:function(d){var b=m(this.element),c=this.options,a=b.data("legend")!="off",f=b.data("labels"),g=b.data("labeltype"),h=.05,n=!0;g||=a?"percent":"key";switch(f){case "off":f=!1;break;case "outside":f=!0;a&&(h=g=="percent"||
g=="value"?.03:.2);break;default:f=!0,n=!1,a?g!="percent"&&g!="value"&&(h=.25):h=.1}var e=nv.models.pieChart().duration(c.transition).x(function(q){return q.label}).y(function(q){return q.value}).showLabels(f).labelType(g).showLegend(a).labelsOutside(n).labelThreshold(h).showTooltipPercent(!0);a=d3.format(c.valueFormat);e.valueFormat(a);c.colors&&e.color(c.colors);var l=b.data("url"),k=b.data("items"),p=this;nv.addGraph(function(){p._getData(function(q){d.datum(q).call(e);e.update();nv.utils.windowResize(e.update);
