...
e(c+"-options").hide(),b.renderFilter?(e(c+"-filters").show(),b.collapseFilter&&(e(c+"-filters legend").siblings().toggle(),e(c+"-filters legend").children().toggle())):e(c+"-options").hide()):a.find(".pt-form-container").hide();b.collapseTable&&(this.table_options.hidden=!0,a.find(".pt-table").hide(),a.find(".pt-show-table").show(),a.find(".pt-hide-table").hide());b.numberFormatter=function(d){var f=b.precision;if(d===null||typeof d=="undefined")return"-";f=f||f==0?d.toFixed(f):d.toString();f=f.split(".");
d=f[0];f=f.length>1?"."+f[1]:"";d=d.replace(new RegExp("\\B(?=(\\d{"+b.thousandGrouping+"})+(?!\\d))","g"),b.thousandSeparator);return d+f};this.refresh()},_destroy:function(){this.table&&this.table.remove();this.chart&&this.chart.empty()},refresh:function(){var a=e(this.element),b=null;this._unbindEvents();var c=a.find('input[type="hidden"][name="pivotdata"]');c.length&&(b=JSON.parse(e(c).first().val()));b?b.method=="count"&&(this.options.precision=0,this.options.minTickSize=1):(b={empty:!0},a.find(".pt-hide-table").hide(),
...
k){return k%2?"odd":"even"});c.append("td").text(function(h){return h[4]});c.selectAll("td.pt-cell").data(function(h,k){return g[k]}).enter().append("td").attr("class","pt-cell").each(b._renderCell,f);l.showTotals&&c.append("td").attr("class","pt-row-total").text(function(h){return h[2][0]});return c},_renderCell:function(a,b,c){b=d3.select(this);for(var d=a.i,f,g=0,l=d.length;g<l;g++){f=d[g];var h=b.append("div").attr("class","pt-cell-value");f===null?h.text(c.none):Array.isArray(f)?h.append("ul").selectAll("li").data(f).enter().append("li").html(function(k){return k}):
h.text(f);l-g>1&&h.append("span").text(" / ")}(a=a.k)&&a.length&&(e(b.node()).data("recordIDs",a),b.append("div").attr("class","pt-cell-zoom"))},_renderCellRecords:function(a,b){var c=e(".pt-cell-zoom",a).removeClass("opened");a=e(".pt-cell-records",a).remove();if(b){var d=this.lookups,f=[],g,l=[];b.forEach(function(k){if(g=d[k]){if(g.constructor===Array){k=g[1];if(l.indexOf(k)!=-1)return;l.push(k);g=g[0]}g&&f.push(g)}});a=e('<div class="pt-cell-records">');var h=e("<ul>").appendTo(a);f.length?(f.sort(function(k,
...
l+" "+f+'</span><div id="'+d+'"  class="pt-chart-icon pt-schart"></div><div id="'+t+'"  class="pt-chart-icon pt-hchart"></div><span class="pt-chart-label">'+l+" "+g+"</span>"));e(b).append(h)}},_truncateLabel:function(a,b){return a&&a.length>b?a.substring(0,b-3).replace(/\s+$/g,"")+"...":a},_renderChart:function(a){var b=e(this.element),c=this.data;e(".pt-chart-contents",b).hide();if(b=this.chart)if(e(b).off("plothover").off("plotclick").empty(),!c.empty&&this.options.renderChart)if(a===!1)this.options.collapseChart=
!0;else{b=this.options.collapseChart;if(typeof a=="undefined"||!a){if(b)return;a=this.chartOptions.currentChart}if(typeof a=="undefined"||!a){if(b)return;a=this.options.defaultChart}if(typeof a!="undefined"&&a){this.options.collapseChart=!1;this.chartOptions.currentChart=a;b=a.type;a=a.axis;var d=c.labels,f=d.per,g=d.layer+" "+f+" "+d.rows;d=d.layer+" "+f+" "+d.cols;f=c.filter;var l=f[0],h=f[1];b=="piechart"?a=="rows"?this._renderPieChart(c.rows,g,l):this._renderPieChart(c.cols,d,h):b=="barchart"?
a=="rows"?this._renderBarChart(c.rows,c.facts,g,l):this._renderBarChart(c.cols,c.facts,d,h):b=="breakdown"?a=="rows"?this._renderBreakDown(c,0,g,f):this._renderBreakDown(c,1,d,f):b=="spectrum"&&this._renderSpectrum(c,a,f)}}},_renderPieChart:function(a,b,c){var d=this.chart;if(d){e(d).css({height:"360px"}).closest(".pt-chart-contents").show();b?e(d).siblings(".pt-chart-title").html("<h4>"+b+"</h4>"):e(d).siblings(".pt-chart-title").empty();var f=[],g=0;for(b=0;b<a.length;b++){var l=a[b];!l[1]&&l[2][0]>=
0&&(f.push({index:l[0],label:l[4],value:l[2][0],key:l[3]}),g+=l[2][0])}var h=this;h.chartOptions.currentDataIndex=null;var k=function(m){var q=m.index;if(h.chartOptions.currentDataIndex!=q){h._removeChartTooltip();h.chartOptions.currentDataIndex=q;m=m.data;var r=m.value,w=d3.event;h._renderChartTooltip(w.pageX,w.pageY,'<div class="pt-tooltip-label">'+m.label+'</div><div class="pt-tooltip-text">'+(r+" ("+Math.round(r/g*100)+"%)</div>"));e(".pt-tooltip-label").css({color:nv.utils.defaultColor()({},
...
q.data;h._chartExplore([[q.index=="__other__"?c+"__belongs":c,q.key]])});d3.select(e(d).get(0)).append("svg").attr("class","nv").datum(f).transition().duration(1200).call(m);nv.utils.windowResize(m.update);return m})}},_renderBarChart:function(a,b,c,d){var f=this.chart;if(f){e(f).closest(".pt-chart-contents").show().css({width:"96%"});for(var g=[],l,h,k,m=0;m<b.length;m++){l={key:b[m][2]};h=[];for(var q=0;q<a.length;q++)k=a[q],h.push({label:k[4],value:k[2][m],filterIndex:k[0],filterKey:k[3]});l.values=
h;g.push(l)}e(f).css({height:"360px"});c?e(f).siblings(".pt-chart-title").html("<h4>"+c+"</h4>"):e(f).siblings(".pt-chart-title").empty();var r=function(t){t=t.data;return'<div class="pt-tooltip"><div class="pt-tooltip-label" style="color:'+nv.utils.defaultColor()({},t.index)+'">'+t.label+'</div><div class="pt-tooltip-text">'+t.value+"</div></div>"},w=this,p=this.options.numberFormatter;nv.addGraph(function(){if(g.length>1){var t=nv.models.multiBarChart().x(function(y){return y.label}).y(function(y){return y.value}).staggerLabels(!0).showControls(!1);
var C=t.multibar}else t=nv.models.discreteBarChart().x(function(y){return y.label}).y(function(y){return y.value}).staggerLabels(!0).showValues(!0),t.valueFormat(p),C=t.discretebar;t.tooltip.contentGenerator(r);t.yAxis.tickFormat(p);t.xAxis.tickFormat(function(y){return w._truncateLabel(y,18)});d3.select(e(f).get(0)).append("svg").attr("class","nv").datum(g).transition().duration(500).call(t);if(w.options.exploreChart&&d)C.dispatch.on("elementClick",function(y){var z=y.data.filterKey;z===null&&(z=
"None");var v=d;y.data.filterIndex=="__other__"&&(v+="__belongs");w._chartExplore([[v,z]])});nv.utils.windowResize(t.update);return t})}},_renderBreakDown:function(a,b,c,d){var f=this.chart;if(f){e(f).closest(".pt-chart-contents").show().css({width:"96%"});var g=a.cells,l=[],h=[];if(b===0){var k=a.rows;var m=a.cols;a=function(v,x){return g[l[v]][h[x]].v[0]};var q=d[0];var r=d[1]}else k=a.cols,m=a.rows,a=function(v,x){return g[h[x]][l[v]].v[0]},q=d[1],r=d[0];var w;d=[];b=[];var p=0;for(w=k.length;p<
w;p++)k[p][1]||(d.push(k[p]),l.push(p));p=0;for(w=m.length;p<w;p++)m[p][1]||(b.push(m[p]),h.push(p));var t=[];for(k=0;k<b.length;k++){m={key:b[k][4],filterIndex:b[k][0],filterKey:b[k][3]};p=[];for(w=0;w<d.length;w++)p.push({label:d[w][4],filterIndex:d[w][0],filterKey:d[w][3],value:a(w,k)});m.values=p;t.push(m)}a=Math.max(d.length*Math.max((b.length+1)*16,50)+70,360);e(f).css({height:a+"px"});c?e(f).siblings(".pt-chart-title").html("<h4>"+c+"</h4>"):e(f).siblings(".pt-chart-title").empty();var C=function(v){var x=
...
v.tooltip.contentGenerator(C);v.valueFormat(z);v.yAxis.tickFormat(z);v.xAxis.tickFormat(function(x){return y._truncateLabel(x,24)});d3.select(e(f).get(0)).append("svg").attr("class","nv").datum(t).call(v);if(y.options.exploreChart&&q&&r)v.multibar.dispatch.on("elementClick",function(x){x=x.data;var E=d3.event.currentTarget.parentElement.__data__,D=E.filterKey;D===null&&(D="None");E=E.filterIndex=="__other__"?r+"__belongs":r;var H=x.filterKey;H===null&&(H="None");y._chartExplore([[x.filterIndex=="__other__"?
q+"__belongs":q,H],[E,D]])});nv.utils.windowResize(v.update);return v})}},_renderSpectrum:function(a,b,c){var d=this.chart;if(d){var f=this,g=a.cells,l=a.labels;if(b=="rows"){var h=a.rows;var k=a.cols;b=l.rows;var m=l.cols;var q=c[0];var r=c[1];var w=function(n,u){return g[n][u]}}else h=a.cols,k=a.rows,b=l.cols,m=l.rows,q=c[1],r=c[0],w=function(n,u){return g[u][n]};var p=function(n,u){return n===null?k[u]:u===null?h[n]:w(n,u)},t=function(n,u){u===J&&(u="silver");for(var B=[],A,F,G=0;G<k.length;G++)A=
p(null,G),F=n===null?A[2][0]:p(n,G).v[0],!A[1]&&A[2][0]>=0&&B.push({filterIndex:A[0],filterKey:A[3],label:A[4],value:F,color:u});return B},C=[],y=0;for(c=0;c<h.length;c++){var z=p(c,null);!z[1]&&z[2][0]>=0&&(C.push({position:c,filterIndex:z[0],filterKey:z[3],label:z[4],value:z[2][0]}),y+=z[2][0])}f.chartOptions.currentDataIndex=null;e(d).removeAttr("style").closest(".pt-chart-contents").css({height:"auto"}).show();e(d).siblings(".pt-chart-title").empty();c=e('<div class="pt-spectrum-pie">').appendTo(d);
...
return{rows:e(a+"-rows").val(),cols:e(a+"-cols").val(),fact:e(a+"-fact").val(),totals:e(a+"-totals").is(":checked")?1:0}},_getFilters:function(){var a="#"+e(this.element).attr("id"),b=null;a=e(a+"-filters");if(a.length)try{b=S3.search.getCurrentFilters(a.first())}catch(c){}return b},_updateURL:function(a,b){var c=[],d={},f;if(b){var g=0;for(f=b.length;g<f;g++){var l=b[g];var h=l[0];d[h]=!0;c.push(h+"="+l[1])}}b=this.options.ajaxURL.split("?");if(b.length>1){l=b[1].split("&");b={};g=0;for(f=l.length;g<
f;g++){var k=l[g].split("=");k.length>1&&(h=decodeURIComponent(k[0]),d[h]||(c.push(h+"="+decodeURIComponent(k[1])),b[h]=!0))}for(h in b)d[h]=!0}b=a.split("?");if(b.length>1)for(l=b[1].split("&"),g=0,f=l.length;g<f;g++)k=l[g].split("="),k.length>1&&(h=decodeURIComponent(k[0]),d[h]||c.push(h+"="+decodeURIComponent(k[1])));a=c.join("&");c=b[0];a&&(c=c+"?"+a);return c},_updateAjaxURL:function(a,b,c){var d=this.options.ajaxURL.split("?"),f=[],g=!1;if(d.length>1){var l=d[1];l=l.split("&")}else l="",l=[];
if(a)for(m in a){var h=a[m];var k=m+"="+h;m=="totals"?this.options.showTotals=h?!0:!1:g||e.inArray(k,l)!=-1||(g=!0);f.push(k)}var m={};var q={},r;if(b){var w=function(t){var C,y,z=[];["contains","anyof","belongs","eq"].forEach(function(v){C=new RegExp("__"+v+"$","g");t.match(C)?y=C:z.push(v)});y&&z.forEach(function(v){q[t.replace(y,"__"+v)]=!0})};h=0;for(r=b.length;h<r;h++){k=b[h];var p=k[0];k=k[1];w(p);k===null?m[p]||(q[p]=!0):(q[p]&&(q[p]=!1),k=p+"="+encodeURIComponent(k),m[p]?m[p].push(k):m[p]=
[k])}}h=0;for(r=l.length;h<r;h++)k=l[h].split("="),k.length>1&&(p=decodeURIComponent(k[0]),k=decodeURIComponent(k[1]),q[p]?g=!0:m[p]?g||e.inArray(p+"="+k,m[p])!=-1||(g=!0):p!="aggregate"&&(a&&a.hasOwnProperty(p)||f.push(l[h])));for(p in m)for(h=0,r=m[p].length;h<r;h++)g||e.inArray(m[p][h],l)!=-1||(g=!0),f.push(m[p][h]);a=f.join("&");d=d[0];a&&(d=d+"?"+a);if(c)return d;this.options.ajaxURL=d;return g},_setExtension:function(a,b){var c=document.createElement("a");c.href=a;a=c.pathname.split("/");var d=
[];a.length&&(a.forEach(function(g){var l=g.lastIndexOf(".");l!=-1?d.push(g.slice(0,l)):d.push(g)}),d[d.length-1]+="."+b,c.pathname=d.join("/"));var f=c.search;f&&(d=f.slice(1).split().filter(function(g){return g.split("=")[0]!="format"}),a.length||d.push("format="+b),c.search="?"+d.join("&"));return c.href},reload:function(a,b,c){c=typeof c!="undefined"?c:!0;typeof b=="undefined"&&(b=this._getFilters());var d=this,f=this.element,g=f.find('input[type="hidden"][name="pivotdata"]');if(g.length){f.find(".pt-throbber").show();
if(a||b)var l=this._updateAjaxURL(a,b);l||c?(a=this.options.ajaxURL,b=this.options.timeout,c=e.ajaxS3,e.searchS3!==J&&(c=e.searchS3),f.find(".pt-empty").hide(),d.openRequest&&(d.openRequest.onreadystatechange=null,d.openRequest.abort()),d.openRequest=c({timeout:b,url:a,dataType:"json",type:"GET",success:function(h){d.openRequest=null;g.first().val(JSON.stringify(h));d.refresh()},error:function(h,k,m){console.log(m=="UNAUTHORIZED"?i18n.gis_requires_login:h.responseText)}})):d.refresh()}},_downloadXLSX:function(){if(this.element.find('input[type="hidden"][name="pivotdata"]').length){var a=
