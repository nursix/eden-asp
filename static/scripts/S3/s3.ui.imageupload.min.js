...
*/
(function(f,S){function K(b,t,k){var h=aa[t.type]||{};if((t.empty||k)&&b==null)return null;if(t.def&&b==null)return t.def;b=h.floor?~~b:parseFloat(b);return b==null||isNaN(b)?t.def:h.mod?(b%=h.mod,b<0?h.mod+b:b):h.min>b?h.min:h.max<b?h.max:b}function F(b){var t=l(),k=t._rgba=[];b=b.toLowerCase();P(q,function(h,B){h=(h=B.re.exec(b))&&B.parse(h);var E=B.space||"rgba";B=C[E].cache;if(h)return h=t[E](h),t[B]=h[B],k=t._rgba=h._rgba,!1});if(k.length!==0)return Math.max.apply(Math,k)===0&&f.extend(k,da.transparent),
t;if(b=da[b])return b}function e(b,t,k){k=(k+1)%1;return k*6<1?b+(t-b)*6*k:k*2<1?t:k*3<2?b+(t-b)*(2/3-k)*6:b}var c=/^([\-+])=\s*(\d+\.?\d*)/,q=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/,parse:function(b){return[b[1],b[2],b[3],b[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)%\s*,\s*(\d+(?:\.\d+)?)%\s*,\s*(\d+(?:\.\d+)?)%\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/,parse:function(b){return[2.55*b[1],2.55*b[2],2.55*b[3],b[4]]}},{re:/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
...
[null,null,null,null],this;if(b instanceof f||b.nodeType)b=b instanceof f?b.css(t):f(b).css(t),t=S;var B=this,E=f.type(b),I=this._rgba=[];t!==S&&(b=[b,t,k,h],E="array");if(E==="string")return this.parse(F(b)||da._default);if(E==="array")return P(T,function(O,z){I[z.idx]=K(b[z.idx],z)}),this;if(E==="object")return b instanceof l?P(C,function(O,z){b[z.cache]&&(B[z.cache]=b[z.cache].slice())}):P(C,function(O,z){P(z.props,function(G,a){var U=z.cache;if(!B[U]&&z.to){if(b[G]==null||G==="alpha")return;B[U]=
z.to(B._rgba)}B[U][a.idx]=K(b[G],a,!0)})}),this},is:function(b){var t=l(b),k=!0,h=this;P(C,function(B,E){var I=t[E.cache];if(I){var O=h[E.cache]||E.to&&E.to(h._rgba)||[];P(E.props,function(z,G){if(I[G.idx]!=null)return k=I[G.idx]===O[G.idx]})}return k});return k},_space:function(){var b=[],t=this;P(C,function(k,h){t[h.cache]&&b.push(k)});return b.pop()},transition:function(b,t){var k=l(b);b=k._space();var h=C[b],B=this[h.cache]||h.to(this._rgba),E=B.slice();k=k[h.cache];P(h.props,function(I,O){I=
O.idx;var z=B[I],G=k[I],a=aa[O.type]||{};G!==null&&(z===null?E[I]=G:(a.mod&&(G-z>a.mod/2?z+=a.mod:z-G>a.mod/2&&(z-=a.mod)),E[O.idx]=K((G-z)*t+z,O)))});return this[b](E)},blend:function(b){if(this._rgba[3]===1)return this;var t=this._rgba.slice(),k=t.pop(),h=l(b)._rgba;return l(f.map(t,function(B,E){return(1-k)*h[E]+k*B}))},toRgbaString:function(){var b="rgba(",t=f.map(this._rgba,function(k,h){return k==null?h>2?1:0:k});t[3]===1&&(t.pop(),b="rgb(");return b+t.join(",")+")"},toHslaString:function(){var b=
"hsla(",t=f.map(this.hsla(),function(k,h){k==null&&(k=h>2?1:0);h&&h<3&&(k=Math.round(k*100)+"%");return k});t[3]===1&&(t.pop(),b="hsl(");return b+t.join(",")+")"},toHexString:function(b){var t=this._rgba.slice(),k=t.pop();b&&t.push(~~(k*255));return"#"+f.map(t,function(h,B){h=(h||0).toString(16);return h.length===1?"0"+h:h}).join("")},toString:function(){return this._rgba[3]===0?"transparent":this.toRgbaString()}};l.fn.parse.prototype=l.fn;C.hsla.to=function(b){if(b[0]==null||b[1]==null||b[2]==null)return[null,
null,null,b[3]];var t=b[0]/255,k=b[1]/255,h=b[2]/255;b=b[3];var B=Math.max(t,k,h),E=Math.min(t,k,h),I=B-E,O=B+E,z=O*.5;return[Math.round(E===B?0:t===B?60*(k-h)/I+360:k===B?60*(h-t)/I+120:60*(t-k)/I+240)%360,z===0||z===1?z:z<=.5?I/O:I/(2-O),z,b==null?1:b]};C.hsla.from=function(b){if(b[0]==null||b[1]==null||b[2]==null)return[null,null,null,b[3]];var t=b[0]/360,k=b[1],h=b[2];b=b[3];k=h<=.5?h*(1+k):h+k-h*k;h=2*h-k;return[Math.round(e(h,k,t+1/3)*255),Math.round(e(h,k,t)*255),Math.round(e(h,k,t-1/3)*255),
b]};P(C,function(b,t){var k=t.props,h=t.cache,B=t.to,E=t.from;l.fn[b]=function(I){B&&!this[h]&&(this[h]=B(this._rgba));if(I===S)return this[h].slice();var O=f.type(I),z=O==="array"||O==="object"?I:arguments,G=this[h].slice();P(k,function(U,ea){U=z[O==="object"?U:ea.idx];U==null&&(U=G[ea.idx]);G[ea.idx]=K(U,ea)});if(E){var a=l(E(G));a[h]=G;return a}return l(G)};P(k,function(I,O){l.fn[I]||(l.fn[I]=function(z){var G=f.type(z),a=I==="alpha"?this._hsla?"hsla":"rgba":b,U=this[a](),ea=U[O.idx];if(G==="undefined")return ea;
G==="function"&&(z=z.call(this,ea),G=f.type(z));if(z==null&&O.empty)return this;G==="string"&&(G=c.exec(z))&&(z=ea+parseFloat(G[2])*(G[1]==="+"?1:-1));U[O.idx]=z;return this[a](U)})})});P("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color outlineColor".split(" "),function(b,t){f.cssHooks[t]={set:function(k,h){var B;if(f.type(h)!=="string"||(B=F(h))){h=l(B||h);if(!N.rgba&&h._rgba[3]!==1){var E=t==="backgroundColor"?k.parentNode:k;do B=f.curCSS(E,"backgroundColor");
while((B===""||B==="transparent")&&(E=E.parentNode)&&E.style);h=h.blend(B&&B!=="transparent"?B:"_default")}h=h.toRgbaString()}k.style[t]=h}};f.fx.step[t]=function(k){k.colorInit||(k.start=l(k.elem,t),k.end=l(k.end),k.colorInit=!0);f.cssHooks[t].set(k.elem,k.start.transition(k.end,k.pos))}});f(function(){var b=document.createElement("div").style;b.cssText="background-color:rgba(1,1,1,.5)";N.rgba=b.backgroundColor.indexOf("rgba")>-1});var da=f.Color.names={aqua:"#00ffff",azure:"#f0ffff",beige:"#f5f5dc",
...
(function(f){f.Jcrop=function(S,K){function F(d){return Math.round(d)+"px"}function e(d){d=f(d).offset();return[d.left,d.top]}function c(d){return[d.pageX-oa[0],d.pageY-oa[1]]}function q(d){typeof d!=="object"&&(d={});a=f.extend(a,d);f.each(["onChange","onSelect","onRelease","onDblClick"],function(w,u){typeof a[u]!=="function"&&(a[u]=function(){})})}function l(d,w,u){oa=e(J);ia.setCursor(d==="move"?d:d+"-resize");if(d==="move")return ia.activateHandlers(aa(w),b,u);w=L.getFixed();var A=T(d),m=L.getCorner(T(A));
...
a.bgColor:a.bgColor),Ca=a.bgColor);ta!=a.bgOpacity&&(ta=a.bgOpacity,a.shade?la.refresh():D.setBgOpacity(ta));ua=a.maxSize[0]||0;va=a.maxSize[1]||0;wa=a.minSize[0]||0;xa=a.minSize[1]||0;a.hasOwnProperty("outerImage")&&(J.attr("src",a.outerImage),delete a.outerImage);D.refresh()}var a=f.extend({},f.Jcrop.defaults),U=navigator.userAgent.toLowerCase(),ea=/msie/.test(U),Da=/msie [1-6]\./.test(U);typeof S!=="object"&&(S=f(S)[0]);typeof K!=="object"&&(K={});q(K);K={border:"none",visibility:"visible",margin:0,
padding:0,position:"absolute",top:0,left:0};var V=f(S);U=!0;if(S.tagName=="IMG"){if(V[0].width!=0&&V[0].height!=0)V.width(V[0].width),V.height(V[0].height);else{var Aa=new Image;Aa.src=V[0].src;V.width(Aa.width);V.height(Aa.height)}var J=V.clone().removeAttr("id").css(K).show();J.width(V.width());J.height(V.height());V.after(J).hide()}else J=V.css(K).show(),U=!1,a.shade===null&&(a.shade=!0);P(J,a.boxWidth,a.boxHeight);var M=J.width(),H=J.height(),ja=f("<div />").width(M).height(H).addClass(a.baseClass+
...
ya.append(ma));Da&&ra.css({overflowY:"hidden"});var sa=a.boundary,na=h().width(M+sa*2).height(H+sa*2).css({position:"absolute",top:F(-sa),left:F(-sa),zIndex:290}).mousedown(t),Ca=a.bgColor,ta=a.bgOpacity,ua,va,wa,xa,Y,ba,pa,Ba,Ea;var oa=e(J);var ha=function(){function d(){var u={},A=["touchstart","touchmove","touchend"],m=document.createElement("div"),p;try{for(p=0;p<A.length;p++){var y=A[p];y="on"+y;var v=y in m;v||(m.setAttribute(y,"return;"),v=typeof m[y]=="function");u[A[p]]=v}return u.touchstart&&
u.touchend&&u.touchmove}catch(Z){return!1}}var w=a.touchSupport===!0||a.touchSupport===!1?a.touchSupport:d();return{createDragger:function(u){return function(A){if(a.disabled||u==="move"&&!a.allowMove)return!1;oa=e(J);pa=!0;l(u,c(ha.cfilter(A)),!0);A.stopPropagation();A.preventDefault();return!1}},newSelection:function(u){return t(ha.cfilter(u))},cfilter:function(u){u.pageX=u.originalEvent.changedTouches[0].pageX;u.pageY=u.originalEvent.changedTouches[0].pageY;return u},isSupported:d,support:w}}(),
L=function(){function d(){if(!a.aspectRatio){var g=y-m,x=v-p;ua&&Math.abs(g)>ua&&(y=g>0?m+ua:m-ua);va&&Math.abs(x)>va&&(v=x>0?p+va:p-va);xa/ba&&Math.abs(x)<xa/ba&&(v=x>0?p+xa/ba:p-xa/ba);wa/Y&&Math.abs(g)<wa/Y&&(y=g>0?m+wa/Y:m-wa/Y);m<0&&(y-=m,m-=m);p<0&&(v-=p,p-=p);y<0&&(m-=y,y-=y);v<0&&(p-=v,v-=v);y>M&&(g=y-M,m-=g,y-=g);v>H&&(g=v-H,p-=g,v-=g);m>M&&(g=m-H,v-=g,p-=g);p>H&&(g=p-H,v-=g,p-=g);return A(u(m,p,y,v))}g=a.aspectRatio;x=a.minSize[0]/Y;var R=a.maxSize[0]/Y,Q=y-m,ca=v-p,r=Math.abs(Q),n=Math.abs(ca);
R===0&&(R=M*10);r/n<g?(r=v,n*=g,n=Q<0?m-n:n+m,n<0?(n=0,r=Math.abs((n-m)/g),r=ca<0?p-r:r+p):n>M&&(n=M,r=Math.abs((n-m)/g),r=ca<0?p-r:r+p)):(n=y,r/=g,r=ca<0?p-r:p+r,r<0?(r=0,n=Math.abs((r-p)*g),n=Q<0?m-n:n+m):r>H&&(r=H,n=Math.abs(r-p)*g,n=Q<0?m-n:n+m));n>m?(n-m<x?n=m+x:n-m>R&&(n=m+R),r=r>p?p+(n-m)/g:p-(n-m)/g):n<m&&(m-n<x?n=m-x:m-n>R&&(n=m-R),r=r>p?p+(m-n)/g:p-(m-n)/g);n<0?(m-=n,n=0):n>M&&(m-=n-M,n=M);r<0?(p-=r,r=0):r>H&&(p-=r-H,r=H);return A(u(m,p,n,r))}function w(g){g[0]<0&&(g[0]=0);g[1]<0&&(g[1]=
...
H]},getScaleFactor:function(){return[Y,ba]},getOptions:function(){return a},ui:{holder:ja,selection:ra}};ea&&ja.bind("selectstart",function(){return!1});V.data("Jcrop",fa);return fa};f.fn.Jcrop=function(S,K){var F;this.each(function(){if(f(this).data("Jcrop")){if(S==="api")return f(this).data("Jcrop");f(this).data("Jcrop").setOptions(S)}else this.tagName=="IMG"?f.Jcrop.Loader(this,function(){f(this).css({display:"block",visibility:"hidden"});F=f.Jcrop(this,S);f.isFunction(K)&&K.call(F)}):(f(this).css({display:"block",
...
this._removeVideoDialog();f(this.element).closest("div.image-upload");const e=this.canvas,c=this;if(e.length){var q=e.width(),l=e.height();this.toScale=!0;if(q==0||l==0)this.toScale=!1,q=l=600;this.canvasSize=[q,l];var C=this.image,aa=this.imageData,T=aa.data("url");T&&(C.src=T,C.onload=function(){e.attr({width:C.width,height:C.height});e[0].getContext("2d").drawImage(C,0,0,C.width,C.height);var N=T.split(".");N=N[N.length-1];N=="jpg"&&(N="jpeg");c.extension=N;let P=aa.data("filename");c.fileName=
...
c),q,l,0,0,q,l);e=N.toDataURL("image/"+this.extension,.99);this._loadImage(e)}},_isValidImage:function(e){e=e.type.split("/");var c=e[e.length-1];if(e[0]=="image"&&f.inArray(c,F)!=-1)return c=="png"||c=="PNG"?"png":"jpeg"},_indicateFileOver:function(e){e.stopPropagation();e.preventDefault();let c=f(e.target);e.type=="dragenter"?c.addClass("hover"):c.removeClass("hover")},_loadSelectedFile:function(e){const c=f(this.element),q=this;this._removeCropAPI();this._indicateFileOver(e);this._hideUpload(!0);
