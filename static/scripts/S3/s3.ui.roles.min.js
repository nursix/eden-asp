...
c(this.element).attr("id");c("#"+a+"-data").val(JSON.stringify(this.assignments))},_assignmentTable:function(){var a=this.options,b=c('<table class="rm-assign">');b.append(this._assignmentTableHead()).append(this._assignmentTableBody());if(a.ajaxURL){a=a.items;var d=!1,e;for(e in a)if(a[e].a!==!1){d=!0;break}d&&b.append(this._assignmentTableFooter())}return b},_assignmentTableHead:function(){var a=this.options,b=c("<thead>"),d=c("<tr>").appendTo(b);var e=a.mode=="users"?m.rm_User:m.rm_Role;c("<th>").text(e).appendTo(d);
...
this._checkNewAssignment()},_resetRealmSelector:function(){var a=this.realmSelector;a&&(c('option[value="null"]',a).length?a.val("null"):a.val(""))},_optionSelected:function(){var a=this.options,b=this.itemSelector,d=this.realmSelector;if(b!==n)if(b=b.val()){if(a=a.items[b])d&&(a.u?(this._resetRealmSelector(),d.prop("disabled",!0).css({visibility:"hidden"})):d.prop("disabled",!1).css({visibility:"visible"})),this._checkNewAssignment()===!1?this._toggleAdd(!1):this._toggleAdd(!0)}else d&&(this._resetRealmSelector(),
d.prop("disabled",!0).css({visibility:"hidden"})),this._toggleAdd(!1)},_realmSelected:function(){this._checkNewAssignment()===!1?this._toggleAdd(!1):this._toggleAdd(!0)},_getNewAssignment:function(){var a=this.itemSelector;if(a){var b=null;if((a=a.val())&&!isNaN(a-0))return this.options.useRealms&&(b=this.realmSelector.val(),b!==null&&(b-=0,isNaN(b)&&(b=null))),[a-0,b]}},_checkNewAssignment:function(){var a=this._getNewAssignment(),b=c(".rm-assignment",c(this.element)).removeClass("rm-duplicate");
...
success:function(){f.assignments.push(b);f._serialize();for(var k=c(".rm-assignment",c(f.element)),l=f._assignmentTableRow(b).hide(),q=k.length;q--;){var r=c(k[q]),t=r.data("assignment");if(f._compareAssignments(t,b)==-1){l.insertAfter(r).fadeIn();l=null;break}}l&&(c("tbody",d.closest(".rm-assign")).prepend(l),l.fadeIn());h.remove();e.show();g.show();f._resetAddRow()},error:function(){var k=c('<span class="rm-error">').insertBefore(h.hide());k.text(m.rm_SubmissionFailed);h.remove();window.setTimeout(function(){k.fadeOut(function(){e.show();
