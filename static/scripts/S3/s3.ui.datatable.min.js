...
f||-1==k||d.splice(k,1)});a.dataTable().api().draw(!1)}},_bulkToggleAllSelected:function(){const a=e(this.element);e(".bulk-select-all",a).prop("checked",!e(".bulkcheckbox:not(:checked)",a).length)},_variableColumnsButton:function(){const a=this.outerForm,b=e(".dataTables_wrapper",a);e(".column-selector",a).length&&!e(".dt-variable-columns",b).length&&e('<button type="button" class="dt-variable-columns"><i class="fa fa-columns"></button>').hide().prop("title",i18n.selectColumns).prependTo(b).variableColumns().show()},
