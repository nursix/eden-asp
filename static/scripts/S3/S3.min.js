...
d&&d.message&&S3.showAlert(d.message,"success"),(g=g.successCallback)&&g.apply(this,arguments))};b.prototype.onFailure=function(d,g){var c=this.AjaxS3;if(c){var e=d.status,h=d.readyState;h=!e&&0===h;if("abort"==g||h){if(c.tryCount=0,c.xhr=null,h)return}else if("timeout"==g){c.tryCount++;e=c.tryCount;h=c.message;if(e<=c.retryLimit){h=i18n.ajax_get+" "+(h?h:i18n.ajax_fmd)+"... "+i18n.ajax_rtr+" "+e;c.alerts.push(S3.showAlert(h,"warning"));c.send();return}c.xhr=null;h=i18n.ajax_wht+" "+e+" "+i18n.ajax_gvn;
S3.showAlert(h,"error")}else 500==e?S3.showAlert(i18n.ajax_500,"error"):-1==c.ignoreStatus.indexOf(e)&&(e=d.responseJSON,h=d.responseText,e&&e.message?S3.showAlert(e.message,"error"):h?S3.showAlert(h,"error"):S3.showAlert(i18n.ajax_dwn,"error"));(c=c.errorCallback)&&c.apply(this,arguments)}};b.prototype.onComplete=function(){var d=this.AjaxS3;d&&(d=d.completeCallback)&&d.apply(this,arguments)};b.prototype.start=function(){if(null===this.xhr){var d=this.message;d&&(d=i18n.ajax_get+" "+(d?d:i18n.ajax_fmd)+
...
var c=$(this);g=c.data("status");var e="menu-options-toggle"==this.id?$("#menu-options"):$("#list-filter");"off"==g?e.hide().removeClass("hide-for-small-only").slideDown(200,function(){c.data("status","on").text(c.data("on"))}):e.slideUp(200,function(){e.addClass("hide-for-small-only").show();c.data("status","off").text(c.data("off"))})})})})();
